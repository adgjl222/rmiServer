...
RedisCache {
    ...
    @Autowired
    private RedisTemplate<String,Object> redisTemplate;//spring封装的使用针对redis使用的类
     ...
     * @return
     */
    public  boolean setS(String key,Object value){
        try {
     ...
     * @return
     */
    public boolean setS(String key,Object value,long time) {
        try {
            if(time>0) {
