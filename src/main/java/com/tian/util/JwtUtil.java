...
public class JwtUtil {
     ...
     * @param userName
     * @param userPassword 登录成功的user对象的用户名和密码
     * @return
     */
    ...
    public static void main(String[] args) {
        String token ="eyJhbGciOiJIUzI1NiJ9.eyJleHAiOjMxMDc4NjE5MjEsInN1YiI6IueOi-aYn-aYnyIsIm5hbWUiOiLnjovmmJ_mmJ8iLCJqdGkiOiIzOTc0Y2MzMi00NTliLTQ0YTYtODdjMS1kZWFjNDEyMjJkNGIiLCJpYXQiOjE1NTM5MzA5NjAsInBhc3N3b3JkIjoiNDg3ODdyamsifQ.q1mfDkUeC5QEozQMIUAFucyPCieC4zuug7lYRTG27KM";
